...
# Добавление теста
st.markdown("<h1 style='text-align: center; color: green; font-family: Times New Roman;'>Данный сайт отображает тренды продовольственной безопасности центральной Азии</h1>", unsafe_allow_html=True)
st.markdown("<h1 style='text-align: center; font-family: Times New Roman;'>Чтобы увидеть график с тенденцией нажмите на соответствующую кнопку с наименованием страны</h1>", unsafe_allow_html=True)
